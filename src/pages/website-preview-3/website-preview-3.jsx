...
const WebsitePreview3 = (props) => {
    ...
    return (
    <WebsitePreviewContainer marginTopMob={props.marginTopMob} minHeightMob={'auto'} heightMob={'100%'}>
        <WebsitePreviewTextContent paddingRightMob={props.paddingRightMob} textAlign={props.textAlign} paddingLeftMob={props.paddingLeftMob ||'10px !important'} paddingBottom={'45px'} paddingTopMob={'10px'} width={'100%'} widthPh={'100vw'}>
