...
const Header = () => {
    ...
    const items = [{value:"ЗАПИСАТЬСЯ СЕЙЧАС", href: '/main', icon:"anchor"},{value:"ОБО МНЕ", href: '/main', icon:"anchor"}, {value:"ОТЗЫВЫ", href: '/main', icon:"anchor"}, {value:"КОНТАКТЫ", href: '/main', icon:"anchor"}]
